...
//
// Cefa $CEFA
// Website: http://cefa.crystalelephant.net/
...
contract Cefa is Context, IERC20, Ownable {
    ...
    string private _name = "Crystal Elephant Farm";
    string private _symbol = "CEFA";
    ...
    // Owner cannot transfer out CEFA from this smart contract
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out CEFA!");
